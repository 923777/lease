...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        IPage<SystemUserItemVo> ipage = systemUserService.pageByQueryVo(new Page <SystemUserItemVo> (current,size),queryVo);
//                .like(queryVo.getName() !=null,SystemUserItemVo::getName,queryVo.getName()));
